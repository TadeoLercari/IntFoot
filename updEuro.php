...
//$user_id = $_GET["id"];
$euro = mysqli_query ($conn,"SELECT * FROM euro WHERE f_tournament = '$f_tournament'");
?>
...
<head>
    ...
    <title>Modifica tu opinion- Euro</title>
                ...
                <div class="container">
                  ...
                  <p class="section-text">
                    Modifica tu opinion
	                 ...
	                 <form action="procesar_actualizarEuro.php" class="enter-exercise" method="post">
	<?php $resultado =  $euro;
			while($row=mysqli_fetch_assoc($resultado)) { ?>	
					...
					<div class="ex-input">
                        ...
                        <input type="text" name="f_tournament" id="f_tournament" class="input-ex" required autocomplete="off">
                    </div>
