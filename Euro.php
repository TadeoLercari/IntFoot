...
<head>
    ...
    <title>Personal view -  Euro</title>

    <!-- CSS -->
    <link rel="stylesheet" href="css/eurowc.css">

    <!-- FAVICON -->
   <link rel="shortcut icon" href="img/5.jpg" type="image/x-icon">
...
<body>
    ...
    <header class="header" data-header>
        ...
        <div class="container">
            ...
            <a href="" class="logo">
                <img src="assets/img/5.jpg" width="70px">
            </a>
        ...
        <article>
            ...
            <section class="hero" id="hero">
                ...
                <div class="container">
                    ...
                    <div class="hero-content">
                        ...
                        <h1 class="h1 hero-title">Inserta tu opinion personal acerca de la Eurocopa</h1>
            ...
            <section class="blog" id="blog">
                ...
                <div class="container">
                  ...
                  <form action="insEuro.php" class="enter-exercise" method="post">
                  ...
                  <div class="container-table">
                    ...
                    <div class="table-title">Euro  IntFoot</div>
                    ...
                    <?php $result = mysqli_query($conn, $euro); 
					...
					<div class="table-item"> <a href="updEuro.php?id=<?php echo $row["f_tournament"];?>&f_match=<?php echo $row["f_match"];?>&first_memory=<?php echo $row["first_memory"];?>&best_memory=<?php echo $row["best_memory"];?>&worst_memory=<?php echo $row["worst_memory"];?>; &f_player=<?php echo $row["f_player"];?>; &f_team=<?php echo $row["f_team"];?>; &best_winner=<?php echo $row["best_winner"];?>; &best_final=<?php echo $row["best_final"];?>; &worst_final=<?php echo $row["worst_final"];?>"class="table-item-link">Editar</a> </div>
                    <div class="table-item"> <a href="procesar_eliminarEuro.php?id=<?php echo $row["f_tournament"];?>" class="table-item-link">Eliminar</a> </div>
