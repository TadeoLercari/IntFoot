...
$actualizar = "UPDATE euro  SET  f_tournament='$f_tournament', f_match='$f_match', first_memory='$first_memory', best_memory='$best_memory', worst_memory='$worst_memory', f_player='$f_player',
